...
// Добавь это в конец файла contentConfig.ts
export const portfolioContent = {
  gomel: {
    mainStore: 'Мастерская в Гомеле',
    mainAddress: 'пр-т Ленина / ул. Советская',
    descriptions: [
      'Профессиональное оборудование для печати',
      'Зона постпечатной обработки',
      'Примеры готовых чертежей и переплетов'
    ],
    defaultSize: 'A4 / A3 / A0',
    yieldRange: [100, 100], // Для совместимости с твоим Asset типом
    defaultOccupancy: 'Live',
  },
  rechitsa: {
    mainStore: 'Точка в Речице',
    mainAddress: 'Центральный район',
    descriptions: [
      'Студия фотопечати и дизайна',
      'Изготовление сувениров',
      'Примеры ламинирования и визиток'
    ],
    defaultSize: '10x15 / A4',
    yieldRange: [100, 100],
    defaultOccupancy: 'Live',
  }
} as const;